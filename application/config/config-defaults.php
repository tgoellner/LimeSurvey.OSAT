...
$config['rootdir']            =   realpath(dirname(__FILE__) . '/../../'); //dirname(__FILE__); // This is the physical disk location for your limesurvey installation. Normally you don't have to touch this setting.
