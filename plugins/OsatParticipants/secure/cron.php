 ...
 *
 */
    $system_path = DOC_ROOT . DIRECTORY_SEPARATOR . "framework";
 ...
 *
 */
    $application_folder = DOC_ROOT . DIRECTORY_SEPARATOR . "application";
 ...
 */
    require_once DOC_ROOT . '/application/Psr4AutoloaderClass.php';
    $loader = new Psr4AutoloaderClass();
    $loader->register();
    $loader->addNamespace('ls\\pluginmanager', DOC_ROOT . '/application/libraries/PluginManager');
    $loader->addNamespace('ls\\pluginmanager', DOC_ROOT . '/application/libraries/PluginManager/Storage');
    $loader->addNamespace('ls\\menu', DOC_ROOT . '/application/libraries/MenuObjects');
/*
 * --------------------------------------------------------------------
...
if (!file_exists(APPPATH . 'config/config' . EXT)) {
    ...
    $sDefaultRuntimePath = DOC_ROOT . DIRECTORY_SEPARATOR.'tmp'.DIRECTORY_SEPARATOR.'runtime';
...
// until here it is exactly the same as index.php
Yii::createApplication('LSYii_Application', $config);

if(require_once(BASEPATH . '/../plugins/OsatParticipants/OsatParticipants.php'))
{
    $manager = new ls\pluginmanager\PluginManager();
    $test = new OsatParticipants($manager, 22);
    $test->isCron(true);
    $test->doCron();
}
exit();
